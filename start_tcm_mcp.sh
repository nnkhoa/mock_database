...
npx supergateway \
    ...
    --stdio "env MYSQL_HOST=127.0.0.1 MYSQL_PORT=3306 MYSQL_USER=root MYSQL_PASS=root MYSQL_DB=textile_tcm_demo mcp-server-mysql" \
    > /tmp/mcp_tcm_server.log 2>&1 &
MCP_PID=$!
